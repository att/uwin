...
Source:		ftp://ftp.hungry.com/pub/hungry/lesstif/lesstif-0.95.0.tar.gz
BuildRoot:	/tmp/lesstif-0.95.0-root
...
%multiarch %attr(644, root, root) /ac_find_motif.m4
