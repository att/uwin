/**
 *
 * $Header: /cvsroot/lesstif/lesstif/lib/Xm-2.1/TextOut.c,v 1.9 2006/04/19 18:42:22 dannybackx Exp $
 *
...
static const char rcsid[] = "$Header: /cvsroot/lesstif/lesstif/lib/Xm-2.1/TextOut.c,v 1.9 2006/04/19 18:42:22 dannybackx Exp $";
...
_XmTextOutSetRenderTable(Widget w, int ofs, XrmValue *v)
{
	...
	if (o->check_set_render_table) {
		...
		o->check_set_render_table = True;
		DEBUGOUT(_LtDebug(__FILE__, w, "_XmTextOutSetRenderTable rt %p\n",
			o->fontlist));
	}
}
