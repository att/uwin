/**
 *
 * $Header: /cvsroot/lesstif/lesstif/lib/Xm-2.1/XmIm.c,v 1.2 2004/10/20 19:32:11 dannybackx Exp $
 *
...
static const char rcsid[] = "$Id: XmIm.c,v 1.2 2004/10/20 19:32:11 dannybackx Exp $";
