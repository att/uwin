...
/* Define if getaddrinfo is broken (if present) */
/* #undef BROKEN_GETADDRINFO */

/* Define if getgroups(0,NULL) will return -1 */
...
#define USER_PATH "/usr/bin:/usr/contrib/bin:/sys:"
...
#define _PATH_SSH_PIDDIR "/usr/etc/ssh"
