...
#if _BLD_DEBUG && !defined(TRACE_ADDRINFO)
#define TRACE_ADDRINFO	1
#endif

#if TRACE_ADDRINFO

extern int	_trace_getaddrinfo(char*, char*, struct addrinfo*, struct addrinfo**, char*, int);
extern void	_trace_freeaddrinfo(struct addrinfo*, char*, int);

#define getaddrinfo(a,b,c,d)	_trace_getaddrinfo(a,b,c,d,__FILE__,__LINE__)
#define freeaddrinfo(a)		_trace_freeaddrinfo(a,__FILE__,__LINE__)
