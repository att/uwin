...
#if _UWIN || _lib_mallinfo && _mem_arena_mallinfo
#if __STD_C
...
#endif
{
	...
	{	mi.arena = (int)sb.extent;
		mi.ordblks = sb.n_busy+sb.n_free;
		mi.uordblks = (int)sb.s_busy;
		mi.fordblks = (int)sb.s_free;
	}
	return mi;
}
#endif /* _lib_mallinfo */

#if _UWIN || _lib_mstats && _mem_bytes_total_mstats
#if __STD_C
