...
/* This file defines the sequences that will trigger the release of the
printer or the locator controller or the termination of the debug mode */

unsigned char PRNCTRL_TERM_VT52[] = "\033X";
unsigned char PRNCTRL_TERM_VTANSI[] = "\033[4i";
unsigned char LOCATORCTRL_TERM[] = "\033[6i";
unsigned char DEBUG_TERM[] = "\033[3h";
