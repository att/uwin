...
#if _HAVE_SOCKADDR_IN_SIN_LEN
#define getsinlen(p)		((p)->sin_len)
#define setsinlen(p)		((p)->sin_len=sizeof(struct sockaddr_in))
#else
#define getsinlen(p)		sizeof(struct sockaddr_in)
#define setsinlen(p)
#endif
